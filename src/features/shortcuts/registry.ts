...
export const SHORTCUTS: readonly ShortcutDef[] = [
  ...
  },
  {
    ...
    label: '新建画布',
    description: '在当前文档里新增一张画布（对应底部标签页栏的「+」）',
    category: '文件',
    scope: 'global',
  },
  ...
  {
    // XMind 的 ZEN 快捷键是 ⌥⌘F，与 ⌘. 并存（后者是 MindGrid 原有绑定，保留不破坏肌肉记忆）
    id: 'view-zen-alt',
    combo: { key: 'f', mod: true, alt: true },
    label: 'ZEN 模式（XMind 绑定）',
    description: '与 ⌘. 等价；XMind 桌面端用的是这组键',
    category: '视图',
    scope: 'global',
  },
  {
  ...
  },
  {
    ...
    label: '查找与替换',
    description: '打开画布内主题搜索（对应菜单「编辑 → 查找与替换」）',
    category: '视图',
    scope: 'canvas',
  },
  {
  ...
  {
    id: 'edit-reset-style',
    combo: { key: '0', mod: true, alt: true },
    label: '重设样式',
    description: '清除当前主题的样式引用与样式覆盖，回到文档主题的样子',
    category: '编辑',
    scope: 'global',
  },
  {
